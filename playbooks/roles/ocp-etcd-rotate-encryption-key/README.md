...
| encryption_type                            | yes       | aescbc                                                                                | Type of encryption used to encrypt the etcd. Set to aesgcm for AES-GCM encryption type and aescbc for AES-CBC encryption type.datastore                                                                                            |
